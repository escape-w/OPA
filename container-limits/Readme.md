# Containers memory and CPU limits

This policy makes sure that all require containers have memory and CPU limits set and within a specified maximum amount.
